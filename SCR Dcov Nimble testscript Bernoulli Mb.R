...
Niminits <- list(z=z.init,N=sum(z.init>0),s=s.init,
                 p0.p=runif(1,0.2,0.8),p0.c=runif(1,0.2,0.8),sigma=runif(1,0.2,0.8),
...
Nimdata <- list(y.p=y.p,y.c=y.c,z=z.data,X=X,dummy.data=dummy.data,cells=data$cells,InSS=data$InSS)
